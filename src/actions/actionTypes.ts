...
import {
  CATEGORY_VIEWER_INIT_RECEIVE,
  CATEGORY_VIEWER_INIT_REQUEST,
  CATEGORY_VIEWER_INIT_REQUEST_FAILED,
  CONTENT_INIT,
  CONTENT_RECEIVE,
  CONTENT_REQUEST,
  ...
  PAGE_VIEWER_CATEGORY_SELECTED,
  PAGE_VIEWER_INIT_RECEIVE,
  PAGE_VIEWER_INIT_REQUEST,
  PAGE_VIEWER_INIT_REQUEST_FAILED} from "./actionConstant";
...
export type IoursesActionTypes =
  | ILoadFailedCoursesAction
  | ILoadSuccesCoursesAction;
...
export type CategoryViewerActionType =
  | IInitCategoriesAction
  | IInitCategoryRequestAction
  | IInitCategoryRequestFailedAction;
...
export type PageViewerActionType =
  | IInitPagesAction
  | ISelectedCategoryPageAction
  | IInitPagesRequestAction
  | IInitPagesRequestFailedAction;
...
export type ContentActions =
  ...
  | IContentReceiveAction
  | IContentRequestFailedAction;
